---
id: tool/external/code/repo_map
kind: Tool
status: published
...
- 实体名称：仓库地图
- 唯一标识：code.repo_map
- executor_ref：builtin:code.repo_map
- input_schema：{"type": "object", "properties": {"path": {"type": "string"}, "limit_files": {"type": "integer"}}}
