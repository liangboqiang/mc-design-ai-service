---
id: tool/external/version/commit
kind: Tool
status: published
...
- 实体名称：提交笔记版本
- 唯一标识：version.commit
- executor_ref：builtin:version.commit
- input_schema：{"type": "object", "properties": {"message": {"type": "string"}, "author": {"type": "string"}, "scope": {"type": "string"}}}
