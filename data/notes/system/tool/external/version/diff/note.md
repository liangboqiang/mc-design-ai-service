...
- 实体名称：版本差异
- 唯一标识：version.diff
- executor_ref：builtin:version.diff
- input_schema：{"type": "object", "properties": {"note_id": {"type": "string"}, "from_commit": {"type": "string"}, "to_commit": {"type": "string"}}}
