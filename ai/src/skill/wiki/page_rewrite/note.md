...
摘要：基于中文元结构、页面真相和用户要求生成可审查草稿。

## 基本信息

- 实体类型：技能
- 实体名称：页面重写技能
- 唯一标识：skill/wiki/page_rewrite
- 当前状态：可用
- 锁定状态：未锁定
- 禁用状态：未禁用
- 最近更新：2026-04-25
...
- 关键词：页面重写技能、Wiki Agent、中文 Wiki、真相治理
- 别名：页面重写技能、skill/wiki/page_rewrite
- 风险等级：中
