---
id: skill/wiki/diagnosis_repair
kind: Skill
status: published
...
摘要：根据页面诊断建议执行可控修复动作，点击修复选项后生成草稿或候选结果。

## 基本信息

- 实体类型：技能
- 实体名称：诊断修复技能
- 唯一标识：skill/wiki/diagnosis_repair
- 当前状态：可用
- 锁定状态：未锁定
- 禁用状态：未禁用
- 最近更新：2026-04-25
...
- 关键词：诊断修复技能、Wiki Agent、中文 Wiki、真相治理
- 别名：诊断修复技能、skill/wiki/diagnosis_repair
- 风险等级：中
...
根据页面诊断建议执行可控修复动作，点击修复选项后生成草稿或候选结果。
