...
摘要：检查页面所在文件夹中除 wiki.md 之外的依赖文件是否发生版本变化，并给出是否需要更新页面的提示。

## 基本信息

- 实体类型：工具
- 实体名称：页面依赖状态检查
- 唯一标识：wiki_app.page_file_status
- 当前状态：可用
- 锁定状态：未锁定
- 禁用状态：未禁用
- 最近更新：2026-04-25
...
- 关键词：页面依赖状态检查、Wiki Agent、页面治理、知识图谱
- 别名：页面依赖状态检查、wiki_app.page_file_status
- 风险等级：中
...
检查页面所在文件夹中除 wiki.md 之外的依赖文件是否发生版本变化，并给出是否需要更新页面的提示。
