---
id: tool/wiki/graph_enhanced_search
kind: Tool
status: published
...
摘要：结合页面文本、作用范围、局部关系和三元组进行增强检索。

## 基本信息

- 实体类型：工具
- 实体名称：图谱增强检索
- 唯一标识：wiki_app.graph_enhanced_search
- 当前状态：可用
- 锁定状态：未锁定
- 禁用状态：未禁用
- 最近更新：2026-04-25
...
- 关键词：图谱增强检索、Wiki Agent、页面治理、知识图谱
- 别名：图谱增强检索、wiki_app.graph_enhanced_search
- 风险等级：中
