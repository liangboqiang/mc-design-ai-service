---
id: tool/wiki/update_system_page_from_files
kind: Tool
status: published
...
摘要：根据系统页面同目录依赖文件的新旧版本差异生成页面更新草稿。系统文件不自动新建页面，只更新已有 wiki.md 页面。

## 基本信息

- 实体类型：工具
- 实体名称：系统页面依赖更新
- 唯一标识：wiki_app.update_system_page_from_files
- 当前状态：可用
- 锁定状态：未锁定
- 禁用状态：未禁用
- 最近更新：2026-04-25
...
- 关键词：系统页面依赖更新、Wiki Agent、页面治理、知识图谱
- 别名：系统页面依赖更新、wiki_app.update_system_page_from_files
- 风险等级：中
...
根据系统页面同目录依赖文件的新旧版本差异生成页面更新草稿。系统文件不自动新建页面，只更新已有 wiki.md 页面。
