---
id: tool/wiki/page_scope_relations
kind: Tool
status: published
...
摘要：读取页面的作用范围、局部关系和链接关系，用于前端小范围关系图展示。

## 基本信息

- 实体类型：工具
- 实体名称：页面局部关系
- 唯一标识：wiki_app.page_scope_relations
- 当前状态：可用
- 锁定状态：未锁定
- 禁用状态：未禁用
- 最近更新：2026-04-25
...
- 关键词：页面局部关系、Wiki Agent、页面治理、知识图谱
- 别名：页面局部关系、wiki_app.page_scope_relations
- 风险等级：中
...
读取页面的作用范围、局部关系和链接关系，用于前端小范围关系图展示。
